...
function buildCoreLearningTracks() {
  return [
    ...
    {
      type: "course",
      title: "TypeScript Beginner to Pro Track",
      summary:
        "A practical TypeScript learning track for developers who want safer JavaScript architecture with real-world app patterns.",
      difficulty: "beginner",
      tags: sanitizeTags(["TypeScript", "JavaScript", "Frontend", "Backend"]),
      sourceRepo: "practical-tutorials/project-based-learning",
      sourceUrl: "https://github.com/practical-tutorials/project-based-learning",
      estimatedHours: 96,
      learningPath: "Type Basics → Functions and Generics → API Types → Production App Structure",
      lessonCount: 36,
      hasCertificate: true,
      studentCount: 15630,
      rating: 4.7,
      practiceCount: 29,
      roadmapSteps: [
        "Core type system and strict mode setup",
        "Functions, interfaces, and generics",
        "Runtime validation and API contracts",
        "React and Node TypeScript integration",
        "Refactoring to reusable typed modules",
      ],
      projectIdeas: ["Typed API client", "Type-safe dashboard", "Reusable validation toolkit"],
      prerequisites: ["Basic JavaScript"],
      outcomes: ["Build safer JavaScript applications with clear type contracts"],
    },
    {
      type: "course",
      title: "Node.js Backend Foundations",
      summary:
        "A beginner-friendly Node.js backend course covering APIs, authentication, data persistence, and deployment basics.",
      difficulty: "beginner",
      tags: sanitizeTags(["Node.js", "Backend", "APIs", "JavaScript"]),
      sourceRepo: "aquadzn/learn-x-by-doing-y",
      sourceUrl: "https://github.com/aquadzn/learn-x-by-doing-y",
      estimatedHours: 88,
      learningPath: "Node Fundamentals → Express APIs → Auth + Data → Deploy and Monitor",
      lessonCount: 34,
      hasCertificate: true,
      studentCount: 13210,
      rating: 4.6,
      practiceCount: 27,
      roadmapSteps: [
        "Node runtime and module fundamentals",
        "Express routes and middleware patterns",
        "Authentication and secure validation",
        "Database integration and query basics",
        "Deployment and observability setup",
      ],
      projectIdeas: ["Auth API", "Task service backend", "Webhook receiver service"],
      prerequisites: ["Basic JavaScript"],
      outcomes: ["Ship beginner-to-intermediate backend services on Node.js"],
    },
    {
      type: "course",
      title: "Frontend Developer Essentials Track",
      summary:
        "A complete beginner path for HTML, CSS, JavaScript, UI accessibility, and frontend deployment confidence.",
      difficulty: "beginner",
      tags: sanitizeTags(["Frontend", "HTML", "CSS", "JavaScript", "UI"]),
      sourceRepo: "nilbuild/developer-roadmap",
      sourceUrl: "https://github.com/nilbuild/developer-roadmap",
      estimatedHours: 102,
      learningPath: "HTML and CSS → JavaScript Fundamentals → UI Accessibility → Project Delivery",
      lessonCount: 38,
      hasCertificate: true,
      studentCount: 21480,
      rating: 4.8,
      ...
      roadmapSteps: [
        ...
        "Testing and performance fundamentals",
        "Frontend project deployment checklist",
      ],
      projectIdeas: ["Portfolio landing page", "Responsive business site", "Interactive onboarding flow"],
      prerequisites: ["Basic computer literacy"],
      outcomes: ["Build and ship frontend projects with strong fundamentals"],
    },
    {
      type: "roadmap",
    ...
    },
    {
      ...
      summary:
        "A focused roadmap for becoming a Python developer through fundamentals, projects, automation, backend, and data workflows.",
      difficulty: "beginner",
      tags: sanitizeTags(["Python", "Roadmap", "Backend", "Automation", "Data Science"]),
      sourceRepo: "BAKUGOS1/pythonprojects",
      sourceUrl: "https://github.com/BAKUGOS1/pythonprojects",
      estimatedHours: 185,
      learningPath: "Absolute Beginner → Python Basics → Projects → Automation → Data Science",
      ...
      roadmapSteps: [
        ...
        "Data structures and file workflows",
        "Beginner project implementation cycle",
        "Automation scripts and API integrations",
        "Backend service fundamentals with FastAPI/Flask",
        "Data analysis starter workflow and capstone",
      ],
      projectIdeas: ["Automation bot", "Simple API", "Data report generator"],
      prerequisites: ["Basic computer usage"],
      outcomes: ["Become a job-oriented Python developer with portfolio projects"],
    },
    {
      type: "roadmap",
      title: "Automation Engineer Roadmap",
      summary:
        "A roadmap for workflow automation, script reliability, integration architecture, and production automation operations.",
      difficulty: "intermediate",
      tags: sanitizeTags(["Automation", "Python", "Roadmap", "DevOps", "Integrations"]),
      sourceRepo: "aquadzn/learn-x-by-doing-y",
      sourceUrl: "https://github.com/aquadzn/learn-x-by-doing-y",
      estimatedHours: 150,
      learningPath: "Scripting Core → Workflow Design → Integrations → Monitoring and Scaling",
      lessonCount: 44,
      hasCertificate: true,
      studentCount: 12440,
      rating: 4.7,
      practiceCount: 34,
      roadmapSteps: [
        "Script design and error handling patterns",
        "Task scheduling and orchestration",
        "API and webhook integration workflows",
        "Data transformation and reporting automation",
        "Monitoring, retries, and incident handling",
      ],
      projectIdeas: ["Invoice automation workflow", "Incident alert bot", "Daily report pipeline"],
      prerequisites: ["Python or JavaScript basics"],
      outcomes: ["Design stable automation systems for real operations"],
    },
    {
      type: "roadmap",
      title: "Data Analyst with Python Roadmap",
      summary:
        "A beginner-to-intermediate path for analytics with Python, visualization, data cleaning, and insight communication.",
      difficulty: "beginner",
      tags: sanitizeTags(["Python", "Data Analysis", "Roadmap", "Pandas", "Visualization"]),
      sourceRepo: "ossu/computer-science",
      sourceUrl: "https://github.com/ossu/computer-science",
      estimatedHours: 172,
      learningPath: "Python Basics → Data Wrangling → Visualization → Analyst Projects",
      lessonCount: 50,
      hasCertificate: true,
      studentCount: 13860,
      rating: 4.7,
      ...
      roadmapSteps: [
        ...
        "Pandas workflows and cleaning strategies",
        "Exploratory analysis and KPI framing",
        "Visualization storytelling and dashboards",
        "Business case studies and final analyst portfolio",
      ],
      projectIdeas: ["Sales dashboard", "Customer churn analysis", "Performance trend report"],
      prerequisites: ["Basic arithmetic and spreadsheet literacy"],
      outcomes: ["Deliver data analysis projects with clear business insight"],
    },
    {
      type: "project",
